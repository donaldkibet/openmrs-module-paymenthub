...
@Repository("openmrs.module.payment.hub.PaymentHubDao")
public class PaymentHubDao {
  ...
  public Item getItemByUuid(String uuid) {
    return (Item)
        getSession().createCriteria(Item.class).add(Restrictions.eq("uuid", uuid)).uniqueResult();
  }
