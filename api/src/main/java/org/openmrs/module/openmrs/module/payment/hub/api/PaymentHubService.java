...
import org.openmrs.module.openmrs.module.payment.hub.PaymentHubConfig;
 ...
 */
public interface PaymentHubService extends OpenmrsService {
   ...
   * @throws APIException
   */
  @Authorized(PaymentHubConfig.MODULE_PRIVILEGE)
  @Transactional
